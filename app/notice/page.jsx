...
const notices = [
  ...
  { id: 27, title: '이용약관 변경 알림', date: '2024-10-18', author: '최수영' },
  { id: 28, title: '보안 패치 적용 안내', date: '2024-10-16', author: '정다희' },
  { id: 29, title: '서버 증설 작업 공지', date: '2024-10-14', author: '김영준' },
  { id: 30, title: '기능 개선 업데이트', date: '2024-10-12', author: '서지은' },
  { id: 31, title: '정기 점검 일정 안내', date: '2024-10-10', author: '최하나' },
  { id: 32, title: '서비스 장애 복구 공지', date: '2024-10-08', author: '장민수' },
  { id: 33, title: '모바일 앱 업데이트', date: '2024-10-06', author: '오지훈' },
  { id: 34, title: '사용자 설문 조사 참여 요청', date: '2024-10-04', author: '김수정' },
];

const NoticeItem = ({ notice }) => (
  <div className={styles.noticeItem}>
    <div>{notice.id}</div>
    <div className={styles.tit_tx}>{notice.title}</div>
    <div>{notice.date}</div>
