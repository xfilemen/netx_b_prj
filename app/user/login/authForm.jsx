      ...
      {type === "requestAccount" && (
        <div className={styles.req_cont}>
          ...
          <div className={styles.info_tx}>
            <ul>
              <li>
                <span className={styles.bul_dot}></span>회사의 업무용
                시스템(PC자산 포함)은 업무 목적에 한정하여 사용함을 원칙으로
                한다.
              </li>
              <li>
                <span className={styles.bul_dot}></span>업무용 시스템을 사용함에
                있어서는 회사의 규정을 준수하고, CJ 구성원의 사생활과 명예를
                존중하는 방식으로 올바르게 사용하여야 한다.
              </li>
              <li>
                <span className={styles.bul_dot}></span>패스워드는 타인에게
                노출되지 않도록 안전하게 관리하여야 한다.
              </li>
              <li>
                <span className={styles.bul_dot}></span>별도의 허가 및 부득이한
                사유 없이 타인의 PC 및 타인의 계정을 이용하지 않아야 한다.
              </li>
              <li>
                <span className={styles.bul_dot}></span>사내망을 통해 다른
                직원의 PC에 임의로 접근하여, 파일을 열람, 변조, 삭제하지 않아야
                한다.
              </li>
              <li>
                <span className={styles.bul_dot}></span>회사는 정보자산의 보호
                및 부정행위 예방/대응을 위하여 임직원의 회사 업무용 시스템 사용
                내역을 기록하고 모니터링 할 수 있다.
              </li>
            </ul>
